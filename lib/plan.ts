export const rooms = [
 {id:'living',name:'Living',side:'ARIPA DE VEST',area:26.38,x:0,z:4.70,w:6.45,d:5.20,measurement:'6.45 × 5.20 m, less recesses',primary:true,detail:'Relaxare și confort',description:'Canapea verde-salvie, două fotolii crem și măsuță ovală. Un living pentru conversație, fără televizor.',visit:[5.65,6.7]},
 ...
 {id:'kitchen',name:'Bucătărie și masă',side:'ARIPA DE EST',area:26.61,x:8.25,z:3.725,w:5.95,d:4.275,measurement:'5.95 × 4.275 m + entry recess',primary:true,detail:'Gătit și mese împreună',description:'Masă din lemn pentru șase persoane și o canapea în colț, pentru cafea și conversație.',visit:[9.25,5.75]},

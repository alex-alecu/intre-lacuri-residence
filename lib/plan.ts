export const rooms = [
 ...
 {id:'daughter',name:'Camera fetiței',side:'ARIPA DE VEST',area:12,x:4,z:0,w:4,d:3,measurement:'4.00 × 3.00 m*',primary:true,detail:'Joacă și povești',description:'Pat-căsuță din lemn, nori luminoși, cort de lectură și dulap închis pentru jucării și cărți.',visit:[5.90,2.35]},
 ...
 {id:'kitchen',name:'Bucătărie și masă',side:'ARIPA DE EST',area:26.61,x:8.25,z:3.725,w:5.95,d:4.275,measurement:'5.95 × 4.275 m + entry recess',primary:true,detail:'Gătit și mese împreună',description:'Masă pentru șase persoane lângă fereastră, rotită cu 90°. Canapea cu spatele spre bucătărie și televizor cu diagonala de 180 cm pe peretele de sud.',visit:[9.65,4.95]},

...
assert.equal(suite.fixtures.filter(o=>o.name==='Television').length,1,'The suite keeps the TV');
...
console.log(`Both layouts checked: 15 cm walls, ${measured.length} furniture bounds, ${targets.length} circulation targets, and the retained original.`);

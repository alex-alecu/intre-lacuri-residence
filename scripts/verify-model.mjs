...
await writeFile('public/measurements.json',JSON.stringify({
 ...
 design:{diningSeats:6,diningTable:{width:1.9,depth:.9},extraSofaRoom:'east dining',cornerSofa:{width:2.45,depth:2.0},diningCoffeeTable:{width:.50,depth:.70},coatWardrobe:{width:1.8,depth:.42,fronts:'sliding'},smallHallWardrobe:{width:1.0,depth:.60,height:2.4,fronts:'sliding'},televisions:0,childBed:'House frame above the retained 0.95 x 1.85 m mattress'},

...
assert.ok(Math.abs(westSofa.x+westSofa.w/2-3.875)<.0001,'The living sofa ends at the east edge of its rear wall');
assert.equal(home.obstacles.some(o=>o.name==='Floor lamp'&&o.x<6.45),false,'The lamp beside the sofa is removed');

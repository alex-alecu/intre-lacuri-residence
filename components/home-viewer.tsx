...
export default function Home() {
  ...
  return <main className={`home-app ${mode==='walk'?'walk-mode':''} ${touch?'touch-device':''} ${expanded?'expanded':''}`}>
    ...
    <Sheet open={notes} onOpenChange={setNotes}><SheetContent className="source-sheet" showCloseButton={false}><SheetClose className="notes-close" aria-label="Închide"><X size={20}/></SheetClose><SheetTitle>Despre amenajare</SheetTitle><SheetDescription>O locuință gândită pentru întreaga familie.</SheetDescription><div className="source-body">
      <h3>Bucătărie și loc de luat masa</h3><p>Bucătăria spațioasă ocupă fostul salon din apartamentul din dreapta. Masa de 1,90 × 0,90 m are șase scaune tapițate. O canapea verde-salvie în colț creează un al doilea loc de relaxare, fără televizor. Dulapurile până la tavan, sertarele adânci și electrocasnicele integrate păstrează blatul liber.</p>
      <h3>Un living pentru relaxare</h3><p>Canapeaua verde-salvie, cele două fotolii crem și măsuța ovală din lemn creează un loc pentru conversație, fără televizor. Biblioteca și mobilierul realizat pe comandă folosesc pereții disponibili. Al doilea birou se află în locul fostei bucătării, integrat în mobilier.</p>
